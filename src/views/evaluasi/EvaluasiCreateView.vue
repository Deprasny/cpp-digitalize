<template>
  <div>
    ...
    <div class="mt-10">
      <BasicForm>
        <BasicCard @tooltip="openInfo" title="FORM EVALUASI" tooltip="true">
          <ToolTip v-if="tooltip" @close="openInfo" class="left-[60%] -top-10">
          ...
          <div class="px-10 py-5">
            <div class="w-full mb-10">
              ...
              <FormEvaluasiItemWrapper>
                <FormInputBasic
                  disabled="true"
                  label="Jabatan"
                  :model-value="selectedNIKValues?.details?.posisi"
                />
                <FormInputBasic
                  disabled="true"
                  label="Divisi / Departement"
                  :model-value="selectedNIKValues?.details?.busunit"
                />
              </FormEvaluasiItemWrapper>
              <FormEvaluasiItemWrapper>
                <FormInputBasic
                  ...
                  label="Tanggal Masuk"
                  type="date"
                  :model-value="selectedNIKValues?.details?.joindate"
                />
                <FormInputBasic
                  disabled="true"
                  label="usia"
                  :model-value="selectedNIKValues?.details?.age"
                />
              </FormEvaluasiItemWrapper>
              <FormEvaluasiItemWrapper>
                <FormInputBasic
                  disabled="true"
                  label="Level"
                  :model-value="selectedNIKValues?.details?.level"
                />
                <FormInputBasic
                  disabled="true"
                  label="Status Karyawan"
                  :model-value="selectedNIKValues?.details?.empstatus"
                />
              </FormEvaluasiItemWrapper>
              <FormEvaluasiItemWrapper>
                <div class="w-full">
                  ...
                  <FormEvaluasiItemWrapper>
                    ...
                    <FormInputBasic
                      ...
                      type="date"
                      placeholder="Sampai"
                      :model-value="selectedNIKValues?.details?.enddate"
                    />
                  </FormEvaluasiItemWrapper>
                </div>
              </FormEvaluasiItemWrapper>
            ...
            <FormTableKompetensi
              ...
              :fetching-score-list-values="isFetchingListProbationScoreComp"
            ...
            <!-- form akhir  -->
            <div class="flex items-start justify-between my-10 w-full">
                  ...
                  <FormEvaluasiItemWrapper class="w-[300px] py-6">
                    <div class="w-full flex gap-2 items-center">
                      <Dropdown
                        ...
                        :selected-option-text="payload.contract_time?.label"
                        @update:selected-option-text="
                          payload.contract_time = $event
                        "
                        :is-loading="isFetchingContractTime"
                      />

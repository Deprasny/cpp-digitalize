<template>
  <div class="mt-28">
    <BasicForm>
      <BasicCard title="FORM MUTASI">
        <div class="px-10 py-5 w-full h-full">
          ...
          <div class="w-full h-full">
            <div class="flex w-full gap-x-2 md:flex-row flex-col pb-10">
              <FormNIKAutocomplete
                ...
                :error-message="[
                  {
                    $uid: '1',
                    $message: 'NIK Tidak Boleh Kosong / NIK Sudah Terdaftar',
                  },
                ]"
              />

              <UIButton variant="form" @click="addName" class="mt-9"
                >Add NIK</UIButton
              >
            </div>
            <div
            ...
            <div class="flex gap-x-7 md:flex-row flex-col">
              <FormInputBasic
                ...
                :is-error="validations?.mut_date.$errors.length > 0"
              ...
              <FormInputBasic
                ...
                :is-error="validations?.mut_reason.$errors.length > 0"
          ...
          >
            <div class="flex flex-col items-start">
              ...
              >
                <FormUploadFile v-model="files" id="upload_mut" />
                <p class="text-xs">
                  Mohon melampirkan struktur organisasi sebelum dan sesudah
                </p>
              </div>
            </div>
          </div>
      ...
      >
        <UIButton variant="form" class="w-[200px]" @click="handleClickSubmit">
          Submit
        </UIButton>
        <UIButton variant="form" class="w-[200px]" @click="handleClickDraft">
          Simpan ke Draft
        </UIButton>
      </div>
    </BasicForm>

  ...
  >
    ...
    >
      ...
      <div class="flex flex-col mt-15">
        <h1 class="mb-5 heading">HR Docs</h1>
        <p class="description">Dokumen Digital HR</p>
      </div>
      <div class="flex mt-5">
    ...
    >
      <div class="flex flex-col px-1 mt-20 sm:px-5 gap-y-5">
        <div class="mb-5">
          ...
          <p class="description">
            Mohon login menggunakan email @cpp.co.id Anda yang sudah terdaftar
          </p>
        </div>
        <form
        ...
        >
          ...
          <UIButton variant="loginGoogle">
            <div class="flex items-center justify-center">
              <img :src="googleIcon" class="w-8 h-8 pr-3" />Masuk Dengan Google
            </div>
          </UIButton>
        </form>
      </div>
